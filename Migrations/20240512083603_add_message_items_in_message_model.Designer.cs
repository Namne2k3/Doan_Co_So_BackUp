...
namespace Doan_Web_CK.Migrations
{
    ...
    [Migration("20240512083603_add_message_items_in_message_model")]
    partial class add_message_items_in_message_model
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Doan_Web_CK.Models.Message", b =>
                {
                    ...
                    b.Property<string>("MessageImages")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ApplicationUserChatRoom", b =>
                {
                    b.HasOne("Doan_Web_CK.Models.ChatRoom", null)
                        .WithMany()
                        .HasForeignKey("ChatroomsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Doan_Web_CK.Models.ApplicationUser", null)
                        .WithMany()
